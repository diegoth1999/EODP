...
class ismConfig:
    ...
    def __init__(self):
        ...
        self.save_after_prnu = False         # detections stage after the PRNU               #True
        self.save_after_ds = False           # detections stage after the Dark Signal        #True
        self.save_detection_stage = False    # detections stage after the bad/dead pixels    #True
