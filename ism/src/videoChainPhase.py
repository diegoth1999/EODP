...
class videoChainPhase(initIsm):
    ...
    def electr2Volt(self, toa, OCF, gain_adc, band):
        ...
        file_path = os.path.join(output_directory, 'E2V.txt')
        ...
        with open(file_path, 'a') as the_file:
            ...
            the_file.write(f'E2V factor = {E2V}\n')
    ...
    def digitisation(self, toa, bit_depth, min_voltage, max_voltage, band):
        ...
        DIGF = toa / toa_dn  # Digitisation - conversion factor
        output_directory = 'C:/Users/diego/PycharmProjects/EODP_TER_2021/EODP-TS-ISM/myoutput/TXT_OUT'
        file_path = os.path.join(output_directory, 'DIGF.txt')
        ...
        with open(file_path, 'a') as the_file:
            the_file.write(f'{band}\n')
            the_file.write(f'Digitisation factor = {DIGF}\n')
